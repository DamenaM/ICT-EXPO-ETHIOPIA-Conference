...
>ICT EXPO Conference page project is created using HTML and CSS Use JavaScript to manipulate DOM elements. Here on the project, I prepared Two page for both mobile and desktop users .
